...
# get Densenet121 pretrained model
import torchvision.models as models
...
def save_checkpoint(model, epoch, optimizer, best_acc):
    ...
    torch.save(state, '/kaggle/working/model_densenet121age_best_checkpoint_modified_batch32.pth')
...
for epoch in range(n_epochs):
    ...
    with open('/kaggle/working/age_densenet121_modified_batch32.log', 'a') as f:
